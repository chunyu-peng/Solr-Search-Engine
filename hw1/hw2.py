...
with open("fetch_foxnews.csv", "r", encoding="UTF-8") as f:
...
with open("visit_foxnews.csv", "r", encoding="UTF-8") as f:
    data = pd.read_csv(f, header=0)
...
with open("urls_foxnews.csv", "r", encoding="UTF-8") as f:
    data = pd.read_csv(f, header=0)
...
with open("CrawlReport_foxnews.txt", "w") as f:
    f.write(f"Name: Chunyu Peng\n")
    f.write(f"USC ID: 3745895256\n")
